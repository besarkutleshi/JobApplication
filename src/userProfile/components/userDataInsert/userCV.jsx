                    ...
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <div className="d-flex justify-content-around">
                                <p style={{ color: "#5A5A5A" }}> Language </p>
                                <p style={{ color: "#5A5A5A" }}> Level of Knowledge </p>
                            </div>
                        </div>
                    </div>
                    {
                        languages.map((element, key) => {
                            return (
                                <div>
                                    <div className="row" key={key}>
                                        <div className="d-flex justify-content-around">
                                            <p className="text-info"> {element.language} </p>
                                            <p className="text-info"> {element.knowledgeLevel} </p>
                                        </div>
                                    </div>
                                </div>
                            )

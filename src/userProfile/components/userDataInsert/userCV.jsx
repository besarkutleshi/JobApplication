...
const UserCV = () => {
    ...
    const education = useSelector((state) => state.userEducation.userEducations);
                                ...
                                <div> 
                                    <div className="row">
                                        <div style={{width:"900px"}}>
                                            <p className="ml-5"> <span className="text-info"> <b> { element.startDate.split('T')[0] } – { element.endDate.split('T')[0] } </b> </span> –  <span className="text-info"> {element.city}, {element.country} </span></p>
